...
class FilesystemTest extends TestCase
{
    ...
    public function providePathCouplesAsCode()
    {
        return array(
            ...
            array('/foo/bin/run', '/foo/vendor/acme/bin/run', true, "dirname(__DIR__, 2).'/vendor/acme/bin/run'"),
            array('/foo/bin/run', '/bar/bin/run', true, "'/bar/bin/run'"),
            array('/bin/run', '/bin/run', true, "__DIR__"),
            array('c:/bin/run', 'c:\\bin/run', true, "__DIR__"),
            array('c:/bin/run', 'c:/vendor/acme/bin/run', true, "dirname(__DIR__, 2).'/vendor/acme/bin/run'"),
            array('c:\\bin\\run', 'c:/vendor/acme/bin/run', true, "dirname(__DIR__, 2).'/vendor/acme/bin/run'"),
            ...
            array('/foo/bar_vendor/src2', '/foo/bar/src/lib', true, "dirname(__DIR__, 2).'/bar/src/lib'"),
