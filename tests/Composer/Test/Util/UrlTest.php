...
class UrlTest extends TestCase
{
    ...
    public static function sanitizeProvider()
    {
        return array(
            ...
            array('http://10a***:***@example.org', 'http://10a8f08e8d7b7b9:foo@example.org'),
            ...
            array('https://ghp***:***@github.com/acme/repo', 'https://ghp_1234567890abcdefghijklmnopqrstuvwxyzAB:x-oauth-basic@github.com/acme/repo'),
            array('https://git***:***@github.com/acme/repo', 'https://github_pat_1234567890abcdefghijkl_1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVW:x-oauth-basic@github.com/acme/repo'),
            array('http://abc***:***@example.org:123/', 'http://abcdefghijkl:bar@example.org:123/'),
            array('https://abc***:***@example.org:123/', 'https://abcdefghijklmnop:bar@example.org:123/'),
            // ghs_<id>_<base64url>.<base64url>.<base64url> installation token — must be masked, not leaked
            array('https://ghs***:***@github.com/acme/repo', 'https://ghs_1234567890_eyJhbGciOiJSUzI1NiJ9.eyJpc3MiOiJjb21wb3NlciJ9.aB-cDef_GHIjkl-mnoPQR0123456:x-oauth-basic@github.com/acme/repo'),
            // token/long username in the user slot without a password (e.g. https://TOKEN@host)
            array('https://ghp***@github.com/acme/repo', 'https://ghp_1234567890abcdefghijklmnopqrstuvwxyzAB@github.com/acme/repo'),
            array('https://git***@github.com/acme/repo', 'https://github_pat_1234567890abcdefghijkl_1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVW@github.com/acme/repo'),
            array('https://ghs***@github.com/acme/repo', 'https://ghs_1234567890_eyJhbGciOiJSUzI1NiJ9.eyJpc3MiOiJjb21wb3NlciJ9.aB-cDef_GHIjkl-mnoPQR0123456@github.com/acme/repo'),
            array('http://10a***@example.org', 'http://10a8f08e8d7b7b9@example.org'),
            array('https://abc***@example.org:123/', 'https://abcdefghijklmnop@example.org:123/'),
            // well-known non-secret credential markers are shown verbatim even though they are 12char+
            array('https://x-token-auth:***@bitbucket.org/acme/repo', 'https://x-token-auth:secret@bitbucket.org/acme/repo'),
            array('https://gitlab-ci-token:***@gitlab.example.org/', 'https://gitlab-ci-token:realtoken@gitlab.example.org/'),
            // without scheme
            array('foo:***@example.org/', 'foo:bar@example.org/'),
            array('foo@example.org/', 'foo@example.org/'),
            array('example.org/', 'example.org/'),
            array('10a***:***@example.org', '10a8f08e8d7b7b9:foo@example.org'),
            array('foo:***@example.org:123/', 'foo:bar@example.org:123/'),
            array('abc***:***@example.org:123/', 'abcdefghijkl:bar@example.org:123/'),
            array('abc***:***@example.org:123/', 'abcdefghijklmnop:bar@example.org:123/'),
            array('ghp***@github.com/acme/repo', 'ghp_1234567890abcdefghijklmnopqrstuvwxyzAB@github.com/acme/repo'),
            array('10a***@example.org', '10a8f08e8d7b7b9@example.org'),
