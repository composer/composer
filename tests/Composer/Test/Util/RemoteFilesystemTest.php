...
class RemoteFilesystemTest extends TestCase
{
    ...
    public function testGetOptionsForUrlCreatesSecureTlsDefaults()
    {
        ...
        $this->assertMatchesRegularExpression('|!aNULL:!eNULL:!EXPORT:!DES:!3DES:!RC4:!MD5:!PSK:!aECDH:!EDH-DSS-DES-CBC3-SHA:!EDH-RSA-DES-CBC3-SHA:!KRB5-DES-CBC3-SHA|', $res['ssl']['ciphers']);
