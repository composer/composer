    ...
    public function install(PackageInterface $package, $path, $output = true)
    {
        ...
        if ($package->getBinaries()) {
            ...
            foreach ($package->getBinaries() as $bin) {
                ...
                // a bin resolving outside of the package would let it chmod an arbitrary host file,
                // this is reported by BinaryInstaller later in the same install (GHSA-96h3-5x6v-m776)
