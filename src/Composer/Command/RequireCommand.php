    ...
    protected function configure()
    {
        $this
            ...
            ->setDefinition(array(
                ...
                new InputOption('with-dependencies', 'w', InputOption::VALUE_NONE, 'Alias for --update-with-dependencies'),
                new InputOption('with-all-dependencies', 'W', InputOption::VALUE_NONE, 'Alias for --update-with-all-dependencies'),
