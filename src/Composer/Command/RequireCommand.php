    ...
    protected function configure()
    {
        $this
            ...
            ->setDefinition(array(
                ...
                new InputOption('update-with-dependencies', null, InputOption::VALUE_NONE, 'Allows inherited dependencies to be updated if those dependencies are not root requirements'),
                new InputOption('update-with-all-dependencies', null, InputOption::VALUE_NONE, 'Allows all inherited dependencies to be updated.'),
