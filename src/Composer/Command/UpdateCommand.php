    ...
    protected function configure(): void
    {
        $this
            ...
            ->setDefinition([
                ...
                new InputOption('no-security-blocking', null, InputOption::VALUE_NONE, 'Allows installing packages with security advisories or that are abandoned. Alias for --no-blocking (can also be set via the COMPOSER_NO_SECURITY_BLOCKING=1 env var).'),
                new InputOption('no-blocking', null, InputOption::VALUE_NONE, 'Disables all policy blocking during this command (can also be set via the COMPOSER_NO_SECURITY_BLOCKING=1 env var).'),
