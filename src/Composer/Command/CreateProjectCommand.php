    ...
    protected function configure(): void
    {
        $this
            ...
            ->setDefinition([
                ...
                new InputOption('no-blocking', null, InputOption::VALUE_NONE, 'Disables all policy blocking during this command. Alias for --no-security-blocking (can also be set via the COMPOSER_NO_SECURITY_BLOCKING=1 env var).'),
