...
class ArrayLoader implements LoaderInterface
{
    ...
    private function configureObject(PackageInterface $package, array $config)
    {
        ...
        if (isset($config['source'])) {
            ...
            $package->setSourceOptions(isset($config['source']['options']) ? $config['source']['options'] : null);
        ...
        if (isset($config['dist'])) {
            ...
            $package->setDistOptions(isset($config['dist']['options']) ? $config['dist']['options'] : null);
