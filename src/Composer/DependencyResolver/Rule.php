...
abstract class Rule
{
    ...
    public const RULE_REQUIRE_FEATURE = 16; // array{packageName: string, feature: string, requiredBy: string[], found: bool}
    public const RULE_FEATURE_REQUIRES = 17; // array{packageName: string, feature: string, link: Link}
    ...
    public function getPrettyString(RepositorySet $repositorySet, Request $request, Pool $pool, bool $isVerbose, array $installedMap = [], array $learnedPool = []): string
    {
        ...
        switch ($this->getReason()) {
            ...
            case self::RULE_REQUIRE_FEATURE:
                /** @var array{packageName: string, feature: string, requiredBy: string[], found: bool} $reasonData */
                $reasonData = $this->getReasonData();
                ...
                return $packageListString.' requires feature "'.$reasonData['feature'].'" for '. $reasonData['packageName'] . ' -> could not be found.' ;
            default:
                $ruleText = '';
