...
class PoolOptimizer
{
    ...
    private function applyRemovalsToPool(Pool $pool): Pool
    {
        ...
        $optimizedPool = new Pool($packages, $pool->getUnacceptableFixedOrLockedPackages(), $removedVersions, $this->removedVersionsByPackage, $pool->getAllSecurityRemovedPackageVersions(), $pool->getAllAbandonedRemovedPackageVersions(), $pool->getAllFilterListRemovedPackageVersions(), $pool->getRequiredFeatures());
