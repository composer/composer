...
// autoload_aliases.php @generated by Composer

return array(

EOF;
        foreach ($autoloads['aliases'] as $alias => $realClass) {
            $aliasesFile .= '    '.var_export($alias, true).' => '.var_export($realClass, true).",\n";
        }
        ...
        file_put_contents($targetDir.'/autoload_aliases.php', $aliasesFile);
    ...
    public function parseAutoloads(array $packageMap, PackageInterface $mainPackage)
    {
        ...
        $aliases = $this->parseAutoloadsType($sortedPackageMap, 'aliases', $mainPackage);
...
HEADER;
        ...
        $aliases = require $targetDir . '/autoload_aliases.php';
        if ($aliases) {
            $loader->addAliases($aliases);
        }
