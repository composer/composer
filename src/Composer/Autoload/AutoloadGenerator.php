...
EOF;
        ...
        $nameSuffix = md5($mainPackage->getName());
        ...
        file_put_contents($targetDir.'/autoload_check'.$suffix.'.php', $this->getAutoloadCheckFile($suffix, $nameSuffix));
        ...
        file_put_contents($targetDir.'/autoload_real'.$suffix.'_'.$nameSuffix.'.php', $this->getAutoloadRealFile(true, true, (bool) $includePathFile, $targetDirLoader, $filesCode, $vendorPathCode, $appBaseDirCode, $suffix, $nameSuffix));
...
require_once $vendorPathToTargetDirCode . '/autoload_check$suffix.php';
...
AUTOLOAD;
    ...
    protected function getAutoloadCheckFile($suffix, $nameSuffix)
    {
$file = <<<FILE
<?php

// autoload_check$suffix.php generated by Composer

if (class_exists('ComposerAutoloaderInit$suffix', false)) {
    return require __DIR__ . '/autoload_real${suffix}_$nameSuffix.php';
}

return require __DIR__ . '/autoload_real$suffix.php';
...
FILE;
    ...
    protected function getAutoloadRealFile($usePSR0, $useClassMap, $useIncludePath, $targetDirLoader, $filesCode, $vendorPathCode, $appBaseDirCode, $suffix, $nameSuffix = null)
    {
...
// autoload_real${suffix}_${nameSuffix}.php generated by Composer
...
class ComposerAutoloaderInit$suffix$nameSuffix
{
...
HEADER;
        ...
        if ($nameSuffix) {
            $file .= <<<HEADER
    public static function initLoader(\$loader)
    {
HEADER;
...
FOOTER;
        if ($nameSuffix) {
            $file .= <<<FOOTER
ComposerAutoloaderInit$suffix$nameSuffix::initLoader(ComposerAutoLoaderInit$suffix::getLoader());
