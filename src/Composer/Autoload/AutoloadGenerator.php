...
EOF;
        ...
        file_put_contents($vendorPath.'/persist_modified_classmap.php', $this->getPersistModifiedClassmapFile($vendorPathToTargetDirCode, $suffix));
...
AUTOLOAD;
    ...
    protected function getPersistModifiedClassmapFile($vendorPathToTargetDirCode, $suffix)
    {
        return <<<PERSIST_MODIFIED_CLASSMAP
<?php
...
return ComposerAutoloaderInit$suffix::persistModifiedClassmap();
