...
EOF;
    ...
    protected function getPlatformCheck($packageMap)
    {
        ...
        $lowestPhpVersion = str_replace('-', '.', $lowestPhpVersion->getVersion());
        $highestPhpVersion = str_replace('-', '.', $highestPhpVersion->getVersion());
...
\$lowerBound = '$lowestPhpVersion';
\$upperBound = '$highestPhpVersion';
