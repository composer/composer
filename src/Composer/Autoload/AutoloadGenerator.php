...
EOF;
        ...
        file_put_contents($targetDir.'/autoload_check'.$suffix.'.php', $this->getAutoloadCheckFile(true, true, (bool) $includePathFile, $targetDirLoader, $filesCode, $vendorPathCode, $appBaseDirCode, $suffix));
...
AUTOLOAD;
    ...
    protected function getAutoloadCheckFile($usePSR0, $useClassMap, $useIncludePath, $targetDirLoader, $filesCode, $vendorPathCode, $appBaseDirCode, $suffix)
    {
        if ($filesCode) {
            $filesCode = "\n\n".rtrim($filesCode);
        }
