...
class AutoloadGenerator
{
    ...
    public function dump(Config $config, InstalledRepositoryInterface $localRepo, PackageInterface $mainPackage, InstallationManager $installationManager, $targetDir, $scanPsr0Packages = false, $suffix = '', $dynamicOptimize = false)
    {
...
EOF;
        ...
        file_put_contents($targetDir.'/autoload_real.php', $this->getAutoloadRealFile(true, true, (bool) $includePathFile, $targetDirLoader, $filesCode, $vendorPathCode, $appBaseDirCode, $suffix, $useGlobalIncludePath, $dynamicOptimize));
...
AUTOLOAD;
    ...
    protected function getAutoloadRealFile($usePSR0, $useClassMap, $useIncludePath, $targetDirLoader, $filesCode, $vendorPathCode, $appBaseDirCode, $suffix, $useGlobalIncludePath, $dynamicOptimize)
    {
...
METHOD_FOOTER;
        ...
        $file .=<<<'PERSIST_MODIFIED_CLASSMAP'
    ...
    public static function persistModifiedClassmap(){
        ...
        $code = "<?php\n// Re-generated by autoload_real::persistModifiedClassmap\nreturn array(\n";
        $classmapName = __DIR__ . '/autoload_classmap.php';

        foreach ($loader->getClassMap() as $className => $fileName){
            $code .= "'$className' => '$fileName',\n";
        }
        $code .= ");\n";
        file_put_contents($classmapName, $code);

        return true;
    }

PERSIST_MODIFIED_CLASSMAP;
