...
EOF;
        ...
        if(!is_null($targetDirLoader)){
            file_put_contents($targetDir.'/autoload_target_dir.php', $this->getAutoloadTargetDirFile($suffix));
        }
...
AUTOLOAD;
    ...
    protected function getAutoloadTargetDirFile($suffix)
    {
        return <<<AUTOLOAD
<?php
...
return array('ComposerAutoloaderInit$suffix', 'autoload');
