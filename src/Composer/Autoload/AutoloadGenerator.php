...
INCLUDE_PATH;
        ...
        $file .= <<<STATIC_INIT
        \$useStaticLoader = PHP_VERSION_ID >= $staticPhpVersion && !defined('HHVM_VERSION') && (!function_exists('zend_loader_file_encoded') || function_exists('zend_loader_file_encoded') && !zend_loader_file_encoded());
        if (\$useStaticLoader) {
