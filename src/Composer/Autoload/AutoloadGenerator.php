...
EOF;
        ...
        file_put_contents($vendorPath.'/autoload.php', $this->getAutoloadFile($vendorPathToTargetDirCode, $suffix, $config->get('bin-dir')));
...
EOF;
    ...
    protected function getAutoloadFile($vendorPathToTargetDirCode, $suffix, $binDir)
    {
        return <<<AUTOLOAD
<?php
