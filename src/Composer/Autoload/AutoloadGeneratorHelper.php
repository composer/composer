...
class AutoloadGeneratorHelper
{
    ...
    public function getNamespacesFile($psr0)
    {
        $namespacesCode = '';
...
EOF;
    ...
    public function getClassmapFile(array $classMap)
    {
        $classmapCode = '';
...
EOF;
    ...
    public function getIncludePathsFile(array $packageMap)
    {
        $includePaths = array();
...
EOF;
    ...
    public function getIncludeFilesFile(array $files)
    {
        $filesCode = '';
...
EOF;
    ...
    public function getAutoloadFile($suffix)
    {
        return <<<AUTOLOAD
<?php
...
AUTOLOAD;
    ...
    public function getAutoloadRealFile($usePSR0, $useClassMap, $useIncludePath, $useIncludeFiles, $suffix, $targetDirLoader, $useGlobalIncludePath)
    {
